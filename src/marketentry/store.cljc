(ns marketentry.store
  "SSoT for the Nepal (NPL) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:foreign-investment-npr` / `:claimed-investment-approval-authority`
  are ground truth for the `investment-approval-authority-mismatch`
  flagship check (FITTA 2075 दफा १७ Department-of-Industry vs.
  Investment-Board-Nepal NPR 6,000,000,000 threshold);
  `:requires-ocr-registration?` / `:ocr-registration-verified?` and
  `:requires-pan?` / `:pan-verified?` are ground truth for the two
  conditional agency-verification checks (Office of the Company
  Registrar / Inland Revenue Department -- two DIFFERENT Nepali
  agencies, modeled as two separate booleans rather than one bundled
  certificate)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kathmandu Civic Systems Pvt. Ltd." :portal "Bolpatra e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-investment-npr 2000000000 :claimed-investment-approval-authority nil
             :requires-ocr-registration? true :ocr-registration-verified? true
             :requires-pan? true :pan-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NPL" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Bolpatra e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-investment-npr 2000000000 :claimed-investment-approval-authority nil
             :requires-ocr-registration? true :ocr-registration-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Pokhara Infra Ventures Pvt. Ltd." :portal "Bolpatra e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "NPL" :status :intake}
    "eng-4" {:id "eng-4" :operator "Himal Hydro Concession Pvt. Ltd." :portal "Bolpatra e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-investment-npr 8000000000 :claimed-investment-approval-authority :department-of-industry
             :requires-ocr-registration? true :ocr-registration-verified? true
             :requires-pan? true :pan-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NPL" :status :intake}
    "eng-5" {:id "eng-5" :operator "Lumbini Export Co. Pvt. Ltd." :portal "Bolpatra e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-investment-npr 2000000000 :claimed-investment-approval-authority nil
             :requires-ocr-registration? true :ocr-registration-verified? false
             :requires-pan? true :pan-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NPL" :status :intake}
    "eng-6" {:id "eng-6" :operator "Biratnagar Logistics Pvt. Ltd." :portal "Bolpatra e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :foreign-investment-npr 2000000000 :claimed-investment-approval-authority nil
             :requires-ocr-registration? true :ocr-registration-verified? true
             :requires-pan? true :pan-verified? false
             :drafted? false :submitted? false
             :jurisdiction "NPL" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               foreign-investment-npr claimed-investment-approval-authority
                               requires-ocr-registration? ocr-registration-verified?
                               requires-pan? pan-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    foreign-investment-npr                  (assoc :engagement/foreign-investment-npr foreign-investment-npr)
    claimed-investment-approval-authority    (assoc :engagement/claimed-investment-approval-authority claimed-investment-approval-authority)
    (some? requires-ocr-registration?)      (assoc :engagement/requires-ocr-registration? requires-ocr-registration?)
    (some? ocr-registration-verified?)      (assoc :engagement/ocr-registration-verified? ocr-registration-verified?)
    (some? requires-pan?)                   (assoc :engagement/requires-pan? requires-pan?)
    (some? pan-verified?)                   (assoc :engagement/pan-verified? pan-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/foreign-investment-npr :engagement/claimed-investment-approval-authority
   :engagement/requires-ocr-registration? :engagement/ocr-registration-verified?
   :engagement/requires-pan? :engagement/pan-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :foreign-investment-npr (:engagement/foreign-investment-npr m)
     :claimed-investment-approval-authority (:engagement/claimed-investment-approval-authority m)
     :requires-ocr-registration? (boolean (:engagement/requires-ocr-registration? m))
     :ocr-registration-verified? (boolean (:engagement/ocr-registration-verified? m))
     :requires-pan? (boolean (:engagement/requires-pan? m))
     :pan-verified? (boolean (:engagement/pan-verified? m))
