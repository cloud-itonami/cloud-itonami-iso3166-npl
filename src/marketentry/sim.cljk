...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (NPL, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up investment-approval-authority-mismatch) ==")
    ...
    (println "== filing/submit eng-4 (investment-approval-authority-mismatch -> HARD hold) ==")
    (println (exec-op actor "t9" {:op :filing/submit :subject "eng-4"} operator))

    (println "== jurisdiction/assess eng-5 (sets up ocr-registration-unverified) ==")
    ...
    (println "== filing/submit eng-5 (ocr-registration-unverified -> HARD hold) ==")
    (println (exec-op actor "t11" {:op :filing/submit :subject "eng-5"} operator))

    (println "== jurisdiction/assess eng-6 (sets up pan-unverified) ==")
    ...
    (println "== filing/submit eng-6 (pan-unverified -> HARD hold) ==")
